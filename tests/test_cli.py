...
class TestAdmin(BaseTest):
    user_collection = MongoTestHelpers.collection.user
    group_collection = MongoTestHelpers.collection.groups
...
class TestBatches(BaseTest):
    batch_collection = MongoTestHelpers.collection.batches

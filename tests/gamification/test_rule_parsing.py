...
from vulyk.blueprints.gamification.core.parsing import JsonRuleParser, RuleParsingException
from vulyk.blueprints.gamification.core.rules import ProjectRule, Rule, RuleValidationException
...
class TestJsonRulesParsing(BaseTest):
    ...
    def test_parse_hash(self):
        ...
        self.assertEqual(JsonRuleParser.parse(string).id, str(hash(name)))

    def test_fail_non_json(self):
        string = "<xml></xml>"

        self.assertRaises(RuleParsingException, lambda: JsonRuleParser.parse(string))
    ...
    def test_fail_adjacent_weekend_tasks(self):
        ...
        self.assertRaises(RuleValidationException, lambda: JsonRuleParser.parse(string))
